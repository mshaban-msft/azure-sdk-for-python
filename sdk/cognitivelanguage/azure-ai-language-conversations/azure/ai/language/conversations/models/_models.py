...
class TranscriptConversationItem(ConversationItemBase):
    ...
    :ivar role: The role of the participant. Known values are: "agent", "customer", "generic".
    :vartype role: str or ~azure.ai.language.conversations.models.Role
    :ivar itn: Inverse Text Normalization representation of input. The inverse-text-normalized form
     is the recognized text from Microsoft’s Speech to Text API, with phone numbers, numbers,
     abbreviations, and other transformations applied.
    :vartype itn: str
    :ivar masked_itn: The Inverse Text Normalized format with profanity masking applied.
    :vartype masked_itn: str
    :ivar text: The display form of the recognized text from speech to text API, with punctuation
     and capitalization added.
    :vartype text: str
    :ivar lexical: The lexical form of the recognized text from speech to text API with the actual
     words recognized.
    :vartype lexical: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword role: The role of the participant. Known values are: "agent", "customer", "generic".
        :paramtype role: str or ~azure.ai.language.conversations.models.Role
        :keyword itn: Inverse Text Normalization representation of input. The inverse-text-normalized
         form is the recognized text from Microsoft’s Speech to Text API, with phone numbers, numbers,
         abbreviations, and other transformations applied.
        :paramtype itn: str
        :keyword masked_itn: The Inverse Text Normalized format with profanity masking applied.
        :paramtype masked_itn: str
        :keyword text: The display form of the recognized text from speech to text API, with
         punctuation and capitalization added.
        :paramtype text: str
        :keyword lexical: The lexical form of the recognized text from speech to text API with the
         actual words recognized.
        :paramtype lexical: str
